  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-md-5.col-sm-10(data-aos="fade-right")
        ...
        p El 
          em Viewpoint
          |, facilita diferentes funciones a partir de los requerimientos del sistema, a partir de allí, se clasifican las visibilidades basado en estas funcionalidades, para posteriormente, realizar el diagrama de casos y escenarios, así como también, la individualización de los requerimientos no funcionales. 
