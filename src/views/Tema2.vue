  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-md-8.col-sm-10
        ...
        ol
          ...
          li.mb-3
            i.fas.fa-circle.cac.me-3
            |Prima el funcionamiento del software.
          li.mb-3
            i.fas.fa-circle.cac.me-3
    ...
    AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--gris")
      ...
      .row(titulo="Para tener en cuenta")
        ...
        p 
          em Healthcare
          |: No obstante, no todos los casos han llegado a buen producto, tal fue el caso de 
          em Healthcare.gov, 
    ...
    .tarjeta--container.row.mb-5
      ...
      .col-md.tarjeta.color-secundario.p-5
        ...
        p Muchos expertos prefieren esta técnica, dado que realmente no requiere mayor preparación ni esfuerzo, simplemente consiste en hacer un análisis simple, es decir, primero hago esto y después aquello. Por ejemplo, vamos a recorrer Colombia desde el norte hasta el sur, entonces comenzamos: Primero por Riohacha, luego Santa Marta, surgen el interrogante ¿puedo ir a Cartagena sin pasar por Barranquilla? si, pero no tiene sentido, primero voy a Barraquilla y luego a Cartagena. Así de simple es la técnica.
